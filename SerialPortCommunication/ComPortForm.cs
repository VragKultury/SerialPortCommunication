...
namespace RF_Control
{
    public partial class ComPortForm : Form
    {
        ...
        private void TestMessage_button_Click(object sender, EventArgs e)
        {
            MainForm.comm.DisplayWindow = Status_richBox;
            TestMsgForm testMsgForm = new TestMsgForm();
            testMsgForm.ShowInTaskbar = false;
            testMsgForm.StartPosition = FormStartPosition.CenterScreen;
            testMsgForm.ShowDialog(this);
        }
        ...
        {
            if (MsgHexMode.Checked == true)
            {
                MainForm.comm.CurrentTransmissionType = RF_Control.CommunicationManager.TransmissionType.Hex;
            }
            else
            {
                MainForm.comm.CurrentTransmissionType = RF_Control.CommunicationManager.TransmissionType.Text;
            }
        }
    }
}
