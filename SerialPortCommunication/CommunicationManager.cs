...
//                           LICENSE INFORMATION
//*****************************************************************************************
//   RF_Control.SerialCommunication Version 1.0.0.0
...
namespace RF_Control
{
    public class CommunicationManager
    {
        ...
        public enum PortOpenStatus { Open, Close }
        ...
        public void ReadData()
        {
            ...
            ReadBuffer = comPort.ReadByte();
            //display the message
            DisplayData(MessageType.Outgoing, 1 + "\n");
        }
        #endregion
        ...
        public bool OpenPort()
        {
            try
            {
                ...
                comPort.Open();
                //display message
                DisplayData(MessageType.Normal, "Port " + comPort.PortName + ", BR " + comPort.BaudRate + " is opened at " + DateTime.Now + "\n");
                //return true
                return true;
            }
            catch (Exception ex)
        ...
        public bool ClosePort()
        {
            try
            {
                ...
                comPort.Close();
                //display message
                DisplayData(MessageType.Normal, "/n Port " + comPort.PortName + " is closed at " + DateTime.Now + "\n");
                //return true
                return true;
            }
            catch (Exception ex)
